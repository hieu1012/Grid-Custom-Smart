...
describe('GridComponent master detail', () => {
    ...
    it('isDetailExpanded (controlled): state do function quyết định, click vẫn emit nhưng không tự toggle', async () => {
        ...
        @Component({
            ...
            imports: [GridComponent, ColumnComponent, DetailTemplateDirective],
            template: `
                <kendo-grid [data]="data" [isDetailExpanded]="expandedFn" (detailExpand)="lastExpand = $event" (detailCollapse)="lastCollapse = $event">
                    <kendo-grid-column field="id" title="ID"></kendo-grid-column>
                    <ng-template kendoGridDetailTemplate let-dataItem>
                        DETAIL: {{ dataItem.id }}
                    </ng-template>
...
describe('GridComponent resizable columns', () => {
    @Component({
        ...
        imports: [GridComponent, ColumnComponent],
        template: `
            <kendo-grid [data]="data" [resizable]="true">
                <kendo-grid-column field="id" title="ID" [width]="80"></kendo-grid-column>
                <kendo-grid-column field="name" title="Name" [width]="100"></kendo-grid-column>
            </kendo-grid>
        `,
    })
...
describe('GridComponent grouping render', () => {
    @Component({
        ...
        template: `
            ...
            >
                <kendo-grid-column field="id" title="ID"></kendo-grid-column>
                <kendo-grid-column field="cat" title="Category"></kendo-grid-column>
            </kendo-grid>
        `,
    })
...
describe('GridComponent grouping with aggregates footer', () => {
    @Component({
        ...
        imports: [GridComponent, ColumnComponent],
        template: `
            <kendo-grid [data]="data" [groupable]="true" [group]="[{ field: 'cat', dir: 'asc', aggregates: [{ field: 'id', aggregate: 'count' }] }]">
                <kendo-grid-column field="id" title="ID"></kendo-grid-column>
                <kendo-grid-column field="cat" title="Category"></kendo-grid-column>
            </kendo-grid>
        `,
