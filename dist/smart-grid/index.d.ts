import * as smart_grid from 'smart-grid';
...
declare class CellTemplateDirective {
    ...
    static ɵdir: _angular_core.ɵɵDirectiveDeclaration<CellTemplateDirective, "[smartGridCellTemplate], [kendoGridCellTemplate]", never, {}, {}, never, never, true, never>;
}
...
declare class HeaderTemplateDirective {
    ...
    static ɵdir: _angular_core.ɵɵDirectiveDeclaration<HeaderTemplateDirective, "[smartGridHeaderTemplate], [kendoGridHeaderTemplate]", never, {}, {}, never, never, true, never>;
}
...
declare class FooterTemplateDirective {
    ...
    static ɵdir: _angular_core.ɵɵDirectiveDeclaration<FooterTemplateDirective, "[smartGridFooterTemplate], [kendoGridFooterTemplate]", never, {}, {}, never, never, true, never>;
}
...
declare class NoRecordsTemplateDirective {
    ...
    static ɵdir: _angular_core.ɵɵDirectiveDeclaration<NoRecordsTemplateDirective, "[smartGridNoRecordsTemplate], [kendoGridNoRecordsTemplate]", never, {}, {}, never, never, true, never>;
}
...
declare class DetailTemplateDirective {
    ...
    static ɵdir: _angular_core.ɵɵDirectiveDeclaration<DetailTemplateDirective, "[smartGridDetailTemplate], [kendoGridDetailTemplate]", never, {}, {}, never, never, true, never>;
}
...
declare class GridComponent {
    ...
    readonly result: _angular_core.Signal<smart_grid.DataResult>;
...
declare class ColumnGroupComponent extends ColumnBase {
    ...
    static ɵcmp: _angular_core.ɵɵComponentDeclaration<ColumnGroupComponent, "smart-grid-column-group, kendo-grid-column-group", never, {}, {}, ["children"], ["*"], true, never>;
}
...
declare class CommandColumnComponent extends ColumnBase {
    ...
    static ɵcmp: _angular_core.ɵɵComponentDeclaration<CommandColumnComponent, "smart-grid-command-column, kendo-grid-command-column", never, { "field": { "alias": "field"; "required": false; }; "sortable": { "alias": "sortable"; "required": false; }; "filterable": { "alias": "filterable"; "required": false; }; "resizable": { "alias": "resizable"; "required": false; }; "width": { "alias": "width"; "required": false; }; "edit": { "alias": "edit"; "required": false; }; "remove": { "alias": "remove"; "required": false; }; "save": { "alias": "save"; "required": false; }; "cancel": { "alias": "cancel"; "required": false; }; }, {}, never, ["*"], true, never>;
}
...
declare class CheckboxColumnComponent extends ColumnBase {
    ...
    static ɵcmp: _angular_core.ɵɵComponentDeclaration<CheckboxColumnComponent, "smart-grid-checkbox-column, kendo-grid-checkbox-column", never, { "field": { "alias": "field"; "required": false; }; "sortable": { "alias": "sortable"; "required": false; }; "filterable": { "alias": "filterable"; "required": false; }; "resizable": { "alias": "resizable"; "required": false; }; "columnMenu": { "alias": "columnMenu"; "required": false; }; "showSelectAll": { "alias": "showSelectAll"; "required": false; }; }, {}, never, ["*"], true, never>;
}
...
declare class RadioColumnComponent extends ColumnBase {
    ...
    static ɵcmp: _angular_core.ɵɵComponentDeclaration<RadioColumnComponent, "smart-grid-radio-column, kendo-grid-radio-column", never, { "field": { "alias": "field"; "required": false; }; "sortable": { "alias": "sortable"; "required": false; }; "filterable": { "alias": "filterable"; "required": false; }; "resizable": { "alias": "resizable"; "required": false; }; "columnMenu": { "alias": "columnMenu"; "required": false; }; }, {}, never, ["*"], true, never>;
}
...
declare class SpanCellTemplateDirective {
    ...
    static ɵdir: _angular_core.ɵɵDirectiveDeclaration<SpanCellTemplateDirective, "[smartGridSpanCellTemplate], [kendoGridSpanCellTemplate]", never, {}, {}, never, never, true, never>;
}
...
declare class SpanColumnComponent extends ColumnBase {
    ...
    static ɵcmp: _angular_core.ɵɵComponentDeclaration<SpanColumnComponent, "smart-grid-span-column, kendo-grid-span-column", never, { "sortable": { "alias": "sortable"; "required": false; }; "filterable": { "alias": "filterable"; "required": false; }; "resizable": { "alias": "resizable"; "required": false; }; "columnMenu": { "alias": "columnMenu"; "required": false; }; }, {}, ["spanCellTemplateDirective", "children"], ["*"], true, never>;
}
...
declare class DataBindingDirective implements AfterViewInit, OnDestroy {
    ...
    set kendoGridDataBinding(value: DataBindingFetch | undefined);
    set smartGridDataBinding(value: DataBindingFetch | undefined);
    ...
    static ɵdir: _angular_core.ɵɵDirectiveDeclaration<DataBindingDirective, "[smartGridDataBinding], [kendoGridDataBinding]", never, { "kendoGridDataBinding": { "alias": "kendoGridDataBinding"; "required": false; }; "smartGridDataBinding": { "alias": "smartGridDataBinding"; "required": false; }; }, {}, never, never, true, never>;
}
 ...
 * ```
 */
declare class SmartGridModule {
    static ɵfac: _angular_core.ɵɵFactoryDeclaration<SmartGridModule, never>;
    static ɵmod: _angular_core.ɵɵNgModuleDeclaration<SmartGridModule, never, [typeof GridComponent, typeof ColumnComponent, typeof ColumnGroupComponent, typeof CommandColumnComponent, typeof CheckboxColumnComponent, typeof RadioColumnComponent, typeof SpanColumnComponent, typeof CellTemplateDirective, typeof HeaderTemplateDirective, typeof FooterTemplateDirective, typeof NoRecordsTemplateDirective, typeof DetailTemplateDirective, typeof SpanCellTemplateDirective, typeof DataBindingDirective], [typeof GridComponent, typeof ColumnComponent, typeof ColumnGroupComponent, typeof CommandColumnComponent, typeof CheckboxColumnComponent, typeof RadioColumnComponent, typeof SpanColumnComponent, typeof CellTemplateDirective, typeof HeaderTemplateDirective, typeof FooterTemplateDirective, typeof NoRecordsTemplateDirective, typeof DetailTemplateDirective, typeof SpanCellTemplateDirective, typeof DataBindingDirective]>;
    static ɵinj: _angular_core.ɵɵInjectorDeclaration<SmartGridModule>;
}
